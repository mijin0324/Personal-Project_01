...
<article id = "main" style="height: 300px;">
	...
	<form action="Delete_Picboard_Pro.jsp?pageNum=<%= pageNum %>" method="post" class="LoginForm">
		...
		<div id="Buttons">
			...
			<input type="button" value="LIST" class="list" onclick="location.href = '../Board/Pic.jsp?pageNum=<%=pageNum%>'">
		</div>	
