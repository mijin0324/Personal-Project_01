...
// 라디오버튼 중 무엇을 선택했느냐에 따라 input 태그의 모양이 달라지므로 설정
$(document).ready(function(){
	
    $('input[name="find_id"]').click(function(){
    	
    	var find_id_check = $('input[name="find_id"]:checked');
...
<article id = "main" style="height: 400px;">
	...
	<div class = "find_id_form">
		...
		<form action = "find_id_Pro.jsp" method="post" class="FindForm" name = "FindForm" onsubmit="return find_ck();">
		
			<div class = "inputDiv">
				EMAIL <input type = "radio" name = "find_id" value = "find_email" checked="checked">
				PHONE <input type = "radio" name = "find_id" value = "find_phone">
				<br>
			</div>
			
				NAME<input type = "text" name = "name" class= "inputFIND name" placeholder="Input your name!">
			
			<div id = "find_id_radioView">
				EMAIL<input type = "text" name = "email"  class= "inputFIND email" placeholder="Input your email!">
			</div>
			
			<input type = "submit" value = "FIND ID!" class="submit" style="width: 320px;"><br>
